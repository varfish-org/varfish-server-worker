...
pub fn load_masked_db_records(path: &Path) -> Result<MaskedDb, anyhow::Error> {
    ...
    let masked_db = pbs::varfish::v1::strucvars::clinvar::MaskedDatabase::decode(
...
mod test {
    ...
    fn load_masked_db_records() -> Result<(), anyhow::Error> {
        ...
        let data = super::pbs::varfish::v1::strucvars::clinvar::MaskedDatabase {
            records: vec![
                super::pbs::varfish::v1::strucvars::clinvar::MaskedDbRecord {
                    chrom_no: 0,
                    start: 1,
                    stop: 2,
                },
